    ...
    <div>
        ...
        <div className="cart-page-container">
            ...
            <div className="price-details">
                 ...
                 <div className="adjust-price"><span>Tax</span><span>{(amount*18)/100}</span></div>
                 <div className="adjust-price"><span>Total</span><span>{amount-(amount/10)+(amount*18)/100}</span></div>
            </div>
        </div>
